...
RSpec.describe 'Method Exercises' do
  ...
  xdescribe 'ASCII translator exercise using #chr' do
  ...
  xdescribe 'common sports exercise using #intersection' do
  ...
  xdescribe 'alphabetical list exercise using #sort and #uniq chained' do
  ...
  xdescribe 'lucky number exercise using a default parameter' do
  ...
  xdescribe 'ASCII code exercise using implicit and explicit return' do
  ...
  xdescribe 'pet pun exercise using console output' do
  ...
  xdescribe 'twenty-first century predicate exercise' do
